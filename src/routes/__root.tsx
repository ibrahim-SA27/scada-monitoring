...
import { SimulationProvider } from "@/components/dashboard/simulation";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "EFFLUENT DASHBOARD" },
      {
        name: "description",
        content:
          "Real-time Industrial Effluent Pollution Monitoring and Automatic Discharge Safety Control System",
      },
      { name: "author", content: "EFFLUENT DASHBOARD" },
      { property: "og:title", content: "EFFLUENT DASHBOARD" },
      {
